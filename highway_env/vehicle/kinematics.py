...
class Vehicle(RoadObject):
    ...
    def step(self, dt: float) -> None:
        ...
        # self.action['acceleration']=self.action['acceleration'] + np.random.triangular(-ext,0,ext)
    ...
    # def getExpectedloc(self, dt:float):
        # steering=
        # if self.crashed:
        #     steering = 0
        #     acceleration = -1.0*self.speed
        ...
        # speed=self.speed + self.action['acceleration'] * dt
    ...
    def to_dict_ext(self, origin_vehicle: "Vehicle" = None, observe_intentions: bool = True) -> dict:
        d = {
            'presence': 1,
            'x': self.position[0],
            'y': self.position[1],
    ...
    def totalTravelDistance(self):
        return (self.position[0]-self.x0)/1e3  ## convert to km
